...
# Given parameters
epsilons = [0.3084, 0.4545, 0.5511, 0.6197]
...
plt.legend(loc='best', title='Passband and Stopband', labels=['Epsilon = 0.3804', 'Epsilon = 0.4545', 'Epsilon = 0.5511', 'Epsilon = 0.6197', 'Passband', 'Stopband'])
plt.grid(True)
